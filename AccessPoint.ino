...
void pagina_principal() 
{
  ...
  html += "<select id='operator' style='width: 30%;'><option value='41'>Tim</option><option value='15'>Vivo</option><option value='31'>Oi</option><option value='21'>Claro</option></select>";
  html += "</div>";
  html += "<div class='input-group' style='width: 30%; display: flex; justify-content: flex-start; align-items: center;'>";
  html += "<label for='number' style='width: 30%;'>Número:</label>";
  html += "<input type='number' id='number' style='width: 30%;'>";
  html += "</div>";
  html += "<div class='input-group' style='width: 30%; display: flex; justify-content: flex-start; align-items: center;'>";
  html += "<label for='message' style='width: 30%;'>Mensagem:</label>";
  html += "<input type='text' id='message' style='width: 30%;'>";
  html += "</div>";
